        ...
        public static bool Add(PokerDataAcess.Models.Task task)
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand(
                  "INSERT INTO tasks (Id, description, completion_criteria, difficulty_level, completed, bundle_id) " +
                  "VALUES (@Id, @Description, @CompletionCriteria ,@DifficultyLevel ,@Completed , @Bundle_id  )", conn);
